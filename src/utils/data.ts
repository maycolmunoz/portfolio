...
export const techStack = [
  ...
  { name: "Livewire", icon: IconBrandLivewire, color: "[#FB70A9]" },
  { name: "Inertia.js", icon: IconBrandInertia, color: "[#9553E9]" },
  { name: "React", icon: IconBrandReact, color: "[#61DAFB]" },
  { name: "Vue", icon: IconBrandVue, color: "[#42B883]" },
  {
    name: "TailwindCSS",
  ...
  { name: "Alpine.js", icon: IconBrandAlpineJs, color: "[#8BC0D0]" },
  { name: "HTML", icon: IconBrandHtml5, color: "[#E34F26]" },
  { name: "CSS", icon: IconBrandCss3, color: "[#1572B6]" },
  { name: "JS", icon: IconBrandJavascript, color: "[#F7DF1E]" },
  {
    name: "FilamentPHP",
  ...
  { name: "API's", icon: IconApi, color: "teal-400" },
  {
